...
/**
 * <p>
 * This is the main XML parser class. All you need is the XML data in a string and you can use this class to parse
 * the data into an {@link XmlTag} object. The following shows how to do that.
 * </p>
 *
 * <pre>
 *     String xmlString = ...;
 ...
 *
 * <p>
 * Note that you are required to load the files if there are any on your own. This class just does the parsing, and
 * doesn't include any file helpers.
 * </p>
 *
...
public final class Xml
{
	 ...
	 *
	 * @param xmlString
	 *            The string containing the contents of XML or the XML formatted data.
	...
	{
		XmlTokenizer tokenizer = new XmlTokenizer(in);
		XmlTag tag = parseTag(tokenizer);
		if (tokenizer.currentToken.type != XmlToken.Type.EOF)
		{
			throw new ParseException(XmlToken.Type.EOF, tokenizer.currentToken);
